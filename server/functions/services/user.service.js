...
class userService {
  ...
  async updateUserInFirestore(userId, updatedData) {
    try {
  ...
  async sendForgetPassword(email) {
    ...
    if (isGoogleUser) {
      console.error(
        'User signed in with Google. Cannot send reset password email.'
      );
      return {
        message:
          'User signed in with Google. Cannot send reset password email.',
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="email-masthead">
                  <a class="email-masthead_name">Cursus</a>
                </td>
              </tr>
              <!-- Email Body -->
              <tr>
                  ...
                  <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="content-cell">
                        ...
                        <p>You requested a password reset. Please use the following button below:</p>
                        <!-- Action -->
